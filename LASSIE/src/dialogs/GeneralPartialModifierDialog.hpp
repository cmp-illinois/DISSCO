#ifndef GENERALPARTIALMODIFIERDIALOG_HPP
#define GENERALPARTIALMODIFIERDIALOG_HPP
...
class GeneralPartialModifierDialog : public QDialog
{
    Q_OBJECT

public:
    explicit GeneralPartialModifierDialog(
    int modifierType,
    int maxPartialCount,
...
#endif // GENERALPARTIALMODIFIERDIALOG_HPP